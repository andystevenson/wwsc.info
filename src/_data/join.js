      ...
      links: [
        {
          ...
          class: "home-dine",
          img:
            "https://images.ctfassets.net/ffrbyg3cfykl/49dxUFtEFQy6fNgoaXEZ7V/dd51f1b62f9d6165d36c9d76becf1605/be-local.png",
      ...
      products: [
        {
          ...
          prices: [
            ...
            // {
            //   interval: 'year',
            //   price: Math.floor(1000 - ((1000 / 12) * 3) / 2),
            //   type: 'offer',
            //   name: 'New Year New Me',
            //   description: 'First 3 months half price, then £1000 pa',
            //   phases: [{ change: 'family-annual-v2' }],
            //   nickname: 'family-annual-offer-new-year-new-me-v1',
            //   discounted: true,
            // },
            // {
            //   interval: 'month',
            ...
            //   type: 'offer',
            //   name: 'New Year New Me',
            //   description: 'First 3 months half price, then £100 pm',
            //   phases: [{ iterations: 2 }, { change: 'family-monthly-v2' }],
            //   nickname: 'family-monthly-offer-new-year-new-me-v1',
            //   discounted: true,
            // },
            // {
            //   interval: 'year',
            //   price: Math.floor(1000 - ((1000 / 12) * 6) / 2),
            //   type: 'offer',
            //   name: 'Set For Summer',
            //   description: 'First 6 months half price, then £1000 pa',
            //   phases: [{ change: 'family-annual-v2' }],
            //   nickname: 'family-annual-set-for-summer-v1',
            //   discounted: true,
            // },
            // {
            //   interval: 'month',
            ...
            //   description: 'First 3 months half price, then £100 pm',
            //   phases: [{ iterations: 2 }, { change: 'family-monthly-v2' }],
            //   nickname: 'family-monthly-set-for-summer-v1',
            //   discounted: true,
            // },
          ],
        },
        {
          ...
          prices: [
            ...
            //   nickname: 'classes-monthly-offer-new-year-new-me-v3',
            //   discounted: true,
            // },
            // {
            //   interval: 'year',
            //   price: Math.floor(600 - ((600 / 12) * 6) / 2),
            //   type: 'offer',
            //   name: 'Set For Summer',
            //   description: 'First 6 months half price, then £600 pa',
            //   phases: [{ change: 'classes-annual-v2' }],
            //   nickname: 'classes-annual-set-for-summer-v1',
            //   discounted: true,
            // },
            // {
            //   interval: 'month',
            ...
            //   description: 'First 3 months half price, then £55 pm',
            //   phases: [{ iterations: 2 }, { change: 'classes-monthly-v2' }],
            //   nickname: 'classes-monthly-set-for-summer-v1',
            //   discounted: true,
            // },
          ],
        },
        {
          ...
          prices: [
            ...
            //   nickname: 'adult-monthly-new-year-new-me-v4',
            //   discounted: true,
            // },
            // {
            //   interval: 'year',
            //   price: Math.floor(550 - ((550 / 12) * 6) / 2),
            //   type: 'offer',
            //   name: 'Set For Summer',
            //   description: 'First 6 months half price, then £550 pa',
            //   phases: [{ change: 'adult-annual-v2' }],
            //   nickname: 'adult-annual-set-for-summer-v1',
            //   discounted: true,
            // },
            // {
            //   interval: 'month',
            ...
            //   description: 'First 3 months half price, then £50 pm',
            //   phases: [{ iterations: 2 }, { change: 'adult-monthly-v2' }],
            //   nickname: 'adult-monthly-set-for-summer-v1',
            //   discounted: true,
            // },
            // {
            //   interval: 'year',
            //   price: Math.floor(550 - ((550 / 12) * 6) / 2),
            //   type: 'offer',
            //   name: 'Set For Summer (ACT)',
            //   description: 'First 6 months half price, then £550 pa',
            //   phases: [{ change: 'adult-annual-v2' }],
            //   nickname: 'adult-annual-set-for-summer-ACT-v1',
            //   discounted: true,
            // },
            // {
            //   interval: 'month',
            ...
            //   description: 'First 3 months half price, then £50 pm',
            //   phases: [{ iterations: 2 }, { change: 'adult-monthly-v2' }],
            //   nickname: 'adult-monthly-set-for-summer-ACT-v1',
            //   discounted: true,
            // },
          ],
        },
        {
          ...
          prices: [
            ...
            //   nickname: 'off-peak-monthly-offer-new-year-new-me-v3',
            //   discounted: true,
            // },
            // {
            //   interval: 'year',
            //   price: Math.floor(400 - ((400 / 12) * 6) / 2),
            //   type: 'offer',
            //   name: 'Set For Summer',
            //   description: 'First 6 months half price, then £400 pa',
            //   phases: [{ change: 'off-peak-annual-v2' }],
            //   nickname: 'off-peak-annual-set-for-summer-v1',
            //   discounted: true,
            // },
            // {
            //   interval: 'month',
            ...
            //   description: 'First 3 months half price, then £37.50 pm',
            //   phases: [{ iterations: 2 }, { change: 'off-peak-monthly-v2' }],
            //   nickname: 'off-peak-monthly-set-for-summer-v1',
            //   discounted: true,
            // },
          ],
        },
        {
          ...
          prices: [
            ...
            //   nickname: 'over-65-annual-offer-new-year-new-me-v1',
            //   discounted: true,
            // },
            // {
            //   interval: 'month',
            ...
            //   name: 'New Year New Me',
            //   description: 'First 3 months half price, then £37.50 pm',
            //   phases: [{ iterations: 2 }, { change: 'over-65-monthly-v2' }],
            //   nickname: 'over-65-monthly-offer-new-year-new-me-v1',
            //   discounted: true,
            // },
            // {
            //   interval: 'year',
            ...
            //   description: 'First 6 months half price, then £400 pa',
            //   phases: [{ change: 'over-65-annual-v2' }],
            //   nickname: 'over-65-annual-set-for-summer-v1',
            //   discounted: true,
            // },
            // {
            //   interval: 'month',
            ...
            //   description: 'First 3 months half price, then £37.50 pm',
            //   phases: [{ iterations: 2 }, { change: 'over-65-monthly-v2' }],
            //   nickname: 'over-65-monthly-set-for-summer-v1',
            //   discounted: true,
            // },
          ],
        },
        {
          ...
          prices: [
            ...
            //   nickname: 'young-adult-annual-offer-new-year-new-me-v1',
            //   discounted: true,
            // },
            // {
            //   interval: 'month',
            ...
            //   name: 'New Year New Me',
            //   description: 'First 3 months half price, then £37.50 pm',
            //   phases: [{ iterations: 2 }, { change: 'young-adult-monthly-v3' }],
            //   nickname: 'young-adult-monthly-offer-new-year-new-me-v1',
            //   discounted: true,
            // },
            // {
            //   interval: 'year',
            ...
            //   description: 'First 6 months half price, then £400 pa',
            //   phases: [{ change: 'young-adult-annual-v3' }],
            //   nickname: 'young-adult-annual-set-for-summer-v1',
            //   discounted: true,
            // },
            // {
            //   interval: 'month',
            ...
            //   description: 'First 3 months half price, then £37.50 pm',
            //   phases: [{ iterations: 2 }, { change: 'young-adult-monthly-v3' }],
            //   nickname: 'young-adult-monthly-set-for-summer-v1',
            //   discounted: true,
            // },
          ],
        },
        ...
        },
        {
          ...
          prices: [
            ...
            {
              interval: "year",
              price: Math.floor(105 - 37.5),
              type: "offer",
              name: "All Court Tennis aged 12-15",
              description:
                "Membership offer following ACT 6-week coaching course",
              phases: [{ change: "aged12-15-annual-v3" }],
              nickname: "aged12-15-annual-act-coaching-offer-v1",
              discounted: true,
            },
          ],
        },
        {
          ...
          prices: [
            ...
            {
              interval: "year",
              price: Math.floor(75 - 37.5),
              type: "offer",
              name: "All Court Tennis aged 5-11",
              description:
                "Membership offer following ACT 6-week coaching course",
              phases: [{ change: "aged5-11-annual-v3" }],
              nickname: "aged5-11-annual-act-coaching-offer-v1",
              discounted: true,
            },
          ],
        },
